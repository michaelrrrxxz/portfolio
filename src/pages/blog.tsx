...
export default function BlogPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-muted px-4 py-12">
      <Card className="w-full max-w-md rounded-2xl shadow-xl border border-dashed border-primary bg-white">
        <CardHeader className="flex items-center justify-center text-center">
          <Construction className="h-10 w-10 text-yellow-500" />
          <CardTitle className="mt-4 text-2xl font-bold">Blog Coming Soon</CardTitle>
        </CardHeader>
